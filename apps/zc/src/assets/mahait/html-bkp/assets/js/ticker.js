  ...
  setInterval(function() {
    if (canTick) {
      ...
      setTimeout(function() {
        ...
        if ($(window).width() < 500) {
          if (
            $('.ticker-container ul div.finished li').width() <
            $(window).width()
          ) {
...
function animateTickerElementHorz() {
  if ($(window).width() < 500) {
    if (
      $('.ticker-container ul div.ticker-active li').width() > $(window).width()
    ) {
      setTimeout(function() {
        $('.ticker-container ul div.ticker-active li').animate(
          {
            'margin-left':
              '-' +
              ($('.ticker-container ul div.ticker-active li').width() -
                $(window).width() +
                15)
          },
          speed - speed / 5,
          ...
          function() {
            setTimeout(function() {
              $('.ticker-container ul div.finished')
