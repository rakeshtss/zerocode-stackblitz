...
@Component({
  selector: 'app-data-list-card-template3',
  templateUrl: './data-list-card-template3.component.html',
  styleUrls: ['./data-list-card-template3.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DataListCardTemplate3Component implements OnInit {
  cardTemplate3ptions: ZcDataListConfig = {
    title: 'Appraisals',
    properties: {
      pagination: {
        autoScroll: false,
      ...
      <div class="card-widget">
        <div class="card-body">
          ...
          <div class="card-body-right">
            ...
            <p class="card-text">Available Stock: <strong>{{row.avilability_stock}}</strong></p>
            <p class="card-text">Make: <strong>{{row.mfgDate}}</strong></p>
          </div>
          <div class="item-price">
             <p class="card-text">Charge: <br/><strong>{{row.price}}</strong></p>
          </div>
          <div class="card-icon">
            <i class="{{row.icon}}"></i>
          </div>
