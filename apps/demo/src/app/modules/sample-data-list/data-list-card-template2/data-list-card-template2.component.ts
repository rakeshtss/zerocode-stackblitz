...
@Component({
  selector: 'app-data-list-card-template2',
  templateUrl: './data-list-card-template2.component.html',
  styleUrls: ['./data-list-card-template2.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DataListCardTemplate2Component implements OnInit {
      ...
      <div class="card-widget">
        <div class="card-body">
          ...
          <div class="card-body-right">
            ...
            <p class="card-text">P: {{row.phone}}</p>
          </div>
        </div>
      </div>
      `,
      dataSource:
        'https://jsonblob.com/api/df741361-1ede-11e9-a35a-3be89981c7dc',
      lazy: true,
      langProps: {},
