...
@Component({
  selector: 'zc-time',
  templateUrl: './zc-time.component.html',
  styleUrls: ['./zc-time.component.scss']
})
export class ZcTimeComponent extends FieldType
  ...
  ngOnInit(): void {
    ...
    if (this.formControl.value) {
      this.to.filedDate = new Date(this.currentDate + ' ' + this.formControl.value);
  ...
  setValue(event) {
    this.formControl.setValue(this.getTimeFormat(event));
  }
  getTimeFormat(d) {
